...
HD_PWD='C:/Users/Torgeir Leithe/Google Drive/stor-skole/TFE4141 Design av digitale system 1/RSA/MonPro/MonPro/MonPro.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MonPro.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MonPro.tcl
