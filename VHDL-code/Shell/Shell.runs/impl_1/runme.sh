...
HD_PWD='C:/git/DD1_project/VHDL-code/Shell/Shell.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RSACore.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RSACore.tcl -notrace
